...
class Confetti_Alt_2 extends StatefulWidget {
...
@override
State<Confetti_Alt_2> createState() => _Confetti_Alt_2State();
}
...
class _Confetti_Alt_2State extends State<Confetti_Alt_2>
  ...
  void initState() {
    ...
    Timer.periodic(new Duration(seconds: 3), (timer) {
      setState(() {    cas_cp!.add(CustomPaint(
    ...
    Timer.periodic(new Duration(seconds: 11), (timer) {
      cas_cp!.removeLast();
    });
  }
  ...
  @override
  void didUpdateWidget(covariant Confetti_Alt_2 oldWidget) {
